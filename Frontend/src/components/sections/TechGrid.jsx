...
import { TECH_CARDS } from './tech/techData';
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{
                    width: '44px', height: '44px', borderRadius: '12px', background: `${c.color}15`,
                    border: `1px solid ${c.color}35`, display: 'flex', alignItems: 'center', justifyContent: 'center'
                  }}>
                    <Icon size={22} color={c.color} />
                  </div>
                  <span style={{ fontSize: '0.72rem', fontFamily: 'monospace', padding: '4px 10px', borderRadius: '9999px', background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255, 255, 255, 0.08)', color: c.color, fontWeight: 700 }}>
                    {c.badge}
                  </span>
                </div>

                <h3 style={{ fontSize: '1.15rem', fontWeight: 700, color: '#ffffff' }}>{c.title}</h3>
                <p style={{ fontSize: '0.85rem', color: '#94a3b8', lineHeight: 1.6, margin: 0 }}>{c.desc}</p>
              </div>
            );
          })}
        </div>
